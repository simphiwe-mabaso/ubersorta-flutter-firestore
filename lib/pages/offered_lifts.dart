...
class OfferedLiftsPage extends StatefulWidget {
  const OfferedLiftsPage({super.key, required this.title});

  final String title;

  @override
  State<OfferedLiftsPage> createState() => _OfferedLiftsPageState();
}

class _OfferedLiftsPageState extends State<OfferedLiftsPage> {
